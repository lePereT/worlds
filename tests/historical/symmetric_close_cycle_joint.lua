...
T.eq(#g:faces(),1,'cyclic support SCC contracts to one joint Face'); T.eq(#g:membranes(),1); T.eq(img[1].faces[af],img[2].faces[bf]); T.eq(img[2].faces[bf],img[3].faces[cf]); T.eq(img[1].points[ax],img[2].points[bx]); T.eq(img[2].points[bx],img[3].points[cx]);
