...
T.ok(ctl and g:is_input(ctl)); T.ok(mid and not g:is_input(mid) and not g:is_terminal(mid),'bridge remains ordinary causal Strand'); T.ok(done and g:is_terminal(done));
return T.count()
