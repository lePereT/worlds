...
T.eq(#g:faces(),1); T.eq(#g:strands(),2,'only external Control and Done survive SCC contraction'); local c=img[1].strands[ctl]; local d=img[2].strands[done]; T.ok(c and g:is_input(c)); T.ok(d and g:is_terminal(d));
