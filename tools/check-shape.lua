...
assert(judgement:match('Q = %(A, B, S, T, R, C, E0%)'),'Question normal form missing')
assert(judgement:match('function M%.new'),'Question constructor missing')
...
assert(query:match('local function allocate'),'exact allocator missing')
...
print('PASS shape 0.6.0 centre/edge split')
